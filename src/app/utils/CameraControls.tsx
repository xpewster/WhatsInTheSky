/* Adapted from https://codesandbox.io/s/react-three-fiber-camera-controls-4jjor?file=/src/camera-controls.tsx */
...
export const CameraControls = forwardRef<CameraControlsDefault, unknown>((_, ref) => {
	...
	useFrame((_, delta) => {
        cameraControls.current.mouseButtons.wheel=CameraControlsDefault.ACTION.ZOOM;
        cameraControls.current?.moveTo(3, 5, 5, false);
